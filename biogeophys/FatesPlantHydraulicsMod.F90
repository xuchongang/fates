...
!       end if !has l_aroot_layer changed?
  ...
  function xylemtaper(pexp, dz) result(chi_tapnotap)
    ...
    ! !DESCRIPTION: Following the theory presented in
    ...
    ! Revised 2019-01-03 BOC: total conductance exponent (qexp) is now a continuous function of the xylem taper exponent (pexp).
                                    ! renamed btap to qexp, a[tap][notap] to kN, little_n to n_ext, to match variable names in Savage et al.
    ...
    real(r8) :: a5,a4,a3,a2,a1,a0   ! coefficients of 5th-order polynomial fit to Savage et al. Fig. 2b (qexp vs. pexp)
                                    ! NOTE: These were obtained by digitizing Fig. 2b (dashed line) and fitting a polynomial using nls() in R
    !
    ! !RESULT
