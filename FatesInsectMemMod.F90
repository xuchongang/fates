module FatesInsectMemMod
    ...
    ! Here are input parameter for each species subroutine
		...
		case(1)
			...
			real(r8), parameter :: Otm2 = -18.0_r8
		...
		case(2)
			...
			real(r8), parameter :: Ofmax = 24_r8
			real(r8), parameter :: ONetp = .142857_r8
			real(r8), parameter :: Otm2 = -12.2_r8
			real(r8), parameter :: ETPT = -15.0_r8 
			real(r8), parameter :: ADSRT = -12.2_r8
