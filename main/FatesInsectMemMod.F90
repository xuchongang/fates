module FatesInsectMemMod
    ...
    !real(r8),parameter :: an = insect_an                         	! controls tree loss rate as a function of beetle and tree density, default=-0.000003212975_r8
    real(r8), parameter :: an = -0.000003212975_r8			! controls tree loss rate as a function of beetle and tree density
    real(r8), parameter :: ab = -1.734634_r8				! controls proportion of beetles that attack
