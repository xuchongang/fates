module FatesInsectMemMod
    ...
    !real(r8),  parameter :: an = insect_an                         	! controls tree loss rate as a function of beetle and tree density, default=-11.616996_r8
    real(r8),  parameter :: an= -11.616996_r8				! controls tree loss rate as a function of beetle and tree density
    real(r8),  parameter :: ab= -6.555214_r8				! controls beetle loss rate as a function of beetle and tree density
