module FatesInsectMemMod
    ...
    !real(r8),parameter :: an = insect_an                         	! controls tree loss rate as a function of beetle and tree density, default=-16.63793_r8
    real(r8), parameter :: an = -16.63793_r8			        ! controls tree loss rate as a function of beetle and tree density
    real(r8), parameter :: ab = -11.69958_r8				! controls proportion of beetles that attack
