module FatesInsectMemMod
    ...
    !real(r8),parameter :: an = insect_an                         	! controls tree loss rate as a function of beetle and tree density, default=-16.918773_r8
    real(r8), parameter :: an = -16.918773_r8				! controls tree loss rate as a function of beetle and tree density
    real(r8), parameter :: ab = -7.561583_r8				! controls beetle loss rate as a function of beetle and tree density
