module FatesInsectMemMod
    ...
    !real(r8),parameter :: an = insect_an                         	! controls tree loss rate as a function of beetle and tree density, default=-17.15619_r8
    real(r8), parameter :: an = -17.15619_r8			        ! controls tree loss rate as a function of beetle and tree density
    real(r8), parameter :: ab = -12.05341_r8				! controls proportion of beetles that attack
